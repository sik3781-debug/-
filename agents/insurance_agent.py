...
_SYS = (
    ...
    "\n\n【목표】\nCEO 유고 리스크 및 임원 퇴직금 재원을 법인 납입 보험으로 설계하여 손금산입 요건(법인세법 기본통칙 19-19-4)을 충족하면서 절세 효과를 최대화한다. 4자 이해관계 중 법인·주주(오너) 리스크 헷지에 집중하며, 보험료 납입 시 법인세 절감액과 수령 시 세무 처리를 수치로 명시한다."
)
