...
class ComprehensiveCorporateTaxAgent(ProfessionalSolutionAgent):
    ...
    법인세법§55 세율 구간(9%·19%·21%·24%)
    법인세법§58의3 이월결손금 60% 한도 공제
    조특§10 R&D 세액공제(중소기업 25%)
    조특§24 통합투자세액공제 · 국기법§47의3 신고 불성실 가산세
    소득세법§127 원천징수 · 외감법§4 외감 대상 법인 연동
    상증§41 특수관계인 이익분여 — 부당행위 연동
    """
