...
class TransferPricingBEPSAgent(ProfessionalSolutionAgent):
    ...
    국조법§39~§42 Pillar 2 최저세율(15%) 적용 대상 판정
    국조령§5의2 정상가격 산정 방법(CUP·재판매·원가가산·이익분할·PSM)
    OECD TPG 2022 이전가격 가이드라인 · BEPS Action 13 CbCR(국가별보고서)
    국조법§6 사전가격합의(APA) · 법인세법§52 부당행위계산 부인
    """
