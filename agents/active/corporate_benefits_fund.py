"""
사내근로복지기금 설계 에이전트 (/사내복지기금) — 4단계 워크플로우

핵심 법령:
  법인세법§24②7호 (사내근로복지기금 출연금 손금산입)
  소득세법§12①마목 (근로자 수령액 비과세 요건)
  조특§16의2 (사내근로복지기금 우리사주 출연 과세특례)
  국기법§47의3 (원천징수 불이행 가산세 — 복지비 지급 시)
  외감법§4 (외감 대상 법인 복지기금 공시 의무)
  상증§45의2 (차명 복지기금 운용 — 명의신탁 의제 주의)
  K-IFRS 1019 (종업원급여 — 복지기금 회계처리)
  근로복지기본법§50 (사내근로복지기금 설립)
  근로복지기본법§52 (출연·운용 절차)
  근로복지기본법§54 (목적사업 열거)
"""
...
class CorporateBenefitsFundAgent:
    ...
    법인세법§24②7호 사내근로복지기금 출연금 손금산입
    소득세법§12①마목 근로자 수령액 비과세 — 전 임직원 일률 지급 요건
    조특§16의2 사내근로복지기금 우리사주 출연 과세특례
    국기법§47의3 원천징수 불이행 가산세 — 복지비 지급 시
    외감법§4 외감 대상 법인 복지기금 공시 의무
    K-IFRS 1019 종업원급여 — 복지기금 회계처리 기준
    상증§45의2 차명 운용 주의 — 명의신탁 증여 의제
    근로복지기본법§50 기금 설립 · §52 출연 · §54 목적사업
    """
