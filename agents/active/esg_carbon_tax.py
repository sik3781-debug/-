...
class ESGCarbonTaxAgent(ProfessionalSolutionAgent):
    ...
    탄소중립기본법§27 탄소세 도입 근거(2027년 시행 예정)
    K-Taxonomy 2026 녹색분류체계(6대 환경목표·Do No Significant Harm)
    EU CBAM(탄소국경조정세) 규정 — 2026년 본격 부과
    자본시장법§159 대규모법인 ESG 공시 의무 · 외감법§5 지속가능성 보고서
    온실가스 배출권 거래 및 할당에 관한 법률§12 배출권 할당 계획
    """
