...
_SYS = (
    ...
    "\n\n【목표】\nE·S·G 항목별 리스크를 0~100 점수로 정량화하여 대기업 공급망 이탈·EU CBAM 과징금·금융 조달 불이익을 사전 차단하는 우선 개선 과제를 제시한다. 법인·금융기관·규제기관 3자 관점을 교차 분석하며, 비용 대비 ESG 점수 향상 효율이 높은 항목을 우선 순위별로 권고한다."
)
